...
namespace __detail {
  ...
  // You do not need to implement or use this.
  template <class I>
  class reverse_iter : public std::iterator<
  ...
  template <typename T>
  class list_row_iter : public std::iterator<std::bidirectional_iterator_tag,
                                             list_row_iter<T>> {
   public:
    // Type renaming
  ...
  template <typename T>
  class list_col_iter : public std::iterator<std::bidirectional_iterator_tag,
                                             list_col_iter<T>> {
   public:
    // Type renaming
